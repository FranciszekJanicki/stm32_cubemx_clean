    ...
    switch (ep_type) {
        ...
        case EP_TYPE_BULK:
            USBx_HC((uint32_t)ch_num)->HCINTMSK =
                USB_OTG_HCINTMSK_XFRCM | USB_OTG_HCINTMSK_STALLM | USB_OTG_HCINTMSK_TXERRM |
        ...
        case EP_TYPE_INTR:
            USBx_HC((uint32_t)ch_num)->HCINTMSK = USB_OTG_HCINTMSK_XFRCM | USB_OTG_HCINTMSK_STALLM |
                                                  ...
                                                  USB_OTG_HCINTMSK_DTERRM | USB_OTG_HCINTMSK_NAKM |
 ...
 * @retval None
 */
void USB_WritePMA(USB_TypeDef const* USBx,
                  uint8_t* pbUsrBuf,
