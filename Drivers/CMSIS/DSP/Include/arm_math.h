 ...
 * \image html park.gif "Stator current space vector and its component in (a,b) and in the d,q
 ...
 * <code>sinVal</code> are the cosine and sine values of theta (rotor flux position).
 * \par Fixed-Point Behavior
